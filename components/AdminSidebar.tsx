...
const PRIVILEGED_ONLY_HREFS = new Set<string>(['/nomina-admin', '/deducciones']);
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 min-h-screen bg-slate-950 border-r border-white/5 flex flex-col">
      {/* Logo */}
